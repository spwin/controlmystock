...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        WasteForm.init('', $('.item_form'), $('.recipe_form'), $('.menu_form'), $('.changed-section-form'), $('input[name="type"]'), $('#wastes-form'), $('select#item_id'), $('select#units'), $('input#value'), <?php echo json_encode($items_units['list']); ?>, <?php echo json_encode($items_units['factors']); ?>);
    });
</script>
@endpush